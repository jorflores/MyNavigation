...
import com.delnortedevs.mynavigation.databinding.FragmentSegundoBinding
...
class SegundoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.i("TEST", args.departamento)

       // val departamento = args.departamento
       // val nombre = args.nombre

        binding.textViewDepartamento.text = args.departamento
        binding.textViewNombre.text = args.nombre
